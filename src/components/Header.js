	...
	return (
		<div className="max-w-[90rem] mx-auto mt-20 py-5">
			...
			<p className="w-3/5 mx-auto leading-relaxed mt-5">
				...
				To download entire datasets at once, refer to our <a href="https://github.com/hj-n/ext-clustering-validation-datasets" className="text-sky-600 hover:underline">GitHub repository</a>.
