			...
			<table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
				<thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
					<tr>
						...
						<th scope="col" className="px-6 py-6">Data (comp)</th>
						<th scope="col" className="px-6 py-6">Label (comp)</th>
						<th scope="col" className="px-6 py-6">Data (npy)</th>
						...
						return (
							<tr key={i} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
								...
								<td className="px-6 py-3">
									<a href={`https://github.com/hj-n/ext-clustering-validation-datasets/raw/master/compressed/${row.key}/data.bin`}>
										<button type="button"
								...
								<td className="px-6 py-3">
									<div className="flex-row">
										<a href={`https://github.com/hj-n/ext-clustering-validation-datasets/raw/master/npy/${row.key}/data.npy`}
